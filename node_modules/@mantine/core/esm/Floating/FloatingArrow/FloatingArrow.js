...
const FloatingArrow = forwardRef((_a, ref) => {
  var _b = _a, { withBorder, position, arrowSize, arrowRadius, visible, arrowX, arrowY } = _b, others = __objRest(_b, ["withBorder", "position", "arrowSize", "arrowRadius", "visible", "arrowX", "arrowY"]);
  if (!visible) {
    return null;
  }
